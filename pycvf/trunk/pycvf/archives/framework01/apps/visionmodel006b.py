...
def recomposef1(base, cliquelist,log):
  s=base.shape
     ...
     mmkov=MarkovModel(
         [
                MarkovModel.CliquesSet(
                    #lambda b:to2d(all_blocks2d1d_i(b.astype(int),4,3,2,2)),
                    (mlop=='train')
                ...
                MarkovModel.CliquesSet(
                    #lambda b:to2d(all_blocks2d1d_i(b.astype(int),3,4,2,2)),
                    (mlop=='train')
