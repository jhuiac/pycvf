...
class MyModel(visionmodel.MyModel):
  ...
  def init_models(self,   mlop="train", mlargs="online=True",basepath="/home/tranx/videodatabase/db7x"):
  ...
  def connect_models(self,   mlop="train", mlargs="online=True",basepath="/home/tranx/videodatabase/db7"):
      self.observed_features+=[
